...
export function HeroSection() {
		...
		<section className="relative overflow-hidden">
			...
			<div className="container relative z-10 px-4 py-20 md:py-32 flex flex-col items-center justify-center min-h-[90vh]">
				...
				>
					...
					>
						<span className="text-gradient">Sahi Kukreja's</span> Portfolio
					</motion.h1>
					...
					>
						I continuously enhance my problem-solving skills and actively participate in speed programming challenges. Committed to continuous learning and personal growth.
					</motion.p>
  ...
  <a href="/Sahil_Kukreja_Resume.pdf" download>
